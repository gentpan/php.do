...
<head>
    ...
    <script>window.qfCsrfToken = <?php echo json_encode(qf_csrf_token()); ?>; window.qfGeoipUrl = <?php echo json_encode(qf_url_page('api/geoip.php')); ?>; window.qfUserTimezone = <?php echo json_encode(qf_user_timezone($me)); ?>; window.qfCurrentUserId = <?php echo json_encode($me ? intval($me['id']) : 0); ?>;</script>
